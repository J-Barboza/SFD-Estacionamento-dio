(function () {
    ...
    function calcTempo(milissegundos) {
        ...
        return `${minutos} minutos e ${segundos}`;
    }
    ...
    function patio() {
        ...
        function adicionar(veiculo, salva) {
            ...
            const verifica = JSON.parse(localStorage.getItem("patio"));
            if (verifica !== null && $("#placa").value) {
                const achei = verifica.find(element => element.placa === `${veiculo.placa}`);
                if (achei) {
